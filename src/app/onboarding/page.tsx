    ...
    <section className="flex min-h-screen items-center justify-center p-8">
      <div className="flex flex-col items-center gap-12">
        ...
        <div className="grid grid-cols-1 gap-20 md:grid-cols-2">
          <div className="group flex h-[360px] w-[320px] flex-col items-center justify-between gap-8 rounded-2xl border-4 border-blue-400 px-8 py-10 shadow-lg transition-transform duration-300 hover:-translate-y-2">
            ...
            <Link
              href={`/login?userType=${UserTypeEnum.LEARNER}`}
              className="flex h-12 cursor-pointer items-center gap-2 rounded-sm px-10 py-2 text-xl transition-all duration-300 group-hover:bg-blue-400/30 group-hover:font-bold group-hover:text-blue-500"
            >
              <span>시작하기</span>
          ...
          <div className="group flex h-[360px] w-[320px] flex-col items-center justify-between gap-8 rounded-2xl border-4 border-orange-400 px-8 py-10 shadow-lg transition-transform duration-300 hover:-translate-y-2">
            ...
            <Link
              href={`/login?userType=${UserTypeEnum.CREATOR}`}
