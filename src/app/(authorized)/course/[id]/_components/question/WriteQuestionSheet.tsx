      ...
      <div className="flex items-center gap-3 flex-shrink-0">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-muted-foreground">
            AI will generate a draft, then you can refine and submit it
          </p>
        </div>
      </div>

      <form ref={formRef} onSubmit={handleSubmit} className="flex flex-col flex-1 mt-6 overflow-hidden">
        <ScrollArea className="flex-1 h-full">
              ...
              {title && content && !isQuestionRefinementFormVisible && (
                <div className="bg-background mt-4 space-y-3 rounded-lg border p-4">
                  ...
                  <Button type="button" onClick={handleApplyDraft} className="w-full gap-2" variant="default">
                    <Check className="size-4" />Apply this draft
                  </Button>
                </div>
              )}
            </div>
          ...
          <div className="space-y-4">
            <div className="bg-background rounded-xl border p-6">
              <div className="mb-4 flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-xs">Review the AI-generated question and make any necessary edits</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="space-y-2">
            ...
            <div className="flex-row gap-2 sm:flex-row flex flex-shrink-0 mt-4">
              <Button
                type="button"
                variant="outline"
                className="flex-1"
